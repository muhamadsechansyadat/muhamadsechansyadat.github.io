...
export default function Contact() {
  return (
    <section id="contact" className="relative py-20 lg:py-28 border-t border-[var(--color-line)]/60">
      ...
      <div className="relative mx-auto max-w-6xl px-5 lg:px-8">
        ...
        <div className="rounded-2xl border border-[var(--color-line-2)] bg-[var(--color-ink-2)] p-8 lg:p-12 overflow-hidden relative">
          ...
          <div className="grid lg:grid-cols-[1.3fr_1fr] gap-10 items-center">
            <div>
              ...
              <h3 className="font-[family-name:var(--font-display)] text-3xl lg:text-4xl font-semibold tracking-[-0.02em] text-[var(--color-bone)]">
