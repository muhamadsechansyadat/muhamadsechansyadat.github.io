...
export default function Footer() {
  return (
    <footer className="border-t border-[var(--color-line)]/60 py-8">
      <div className="mx-auto max-w-6xl px-5 lg:px-8 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-[12px] text-[var(--color-mute)] font-mono">
